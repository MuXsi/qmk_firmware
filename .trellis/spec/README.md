...
Project and stack-specific coding standards.

## Structure

### [Firmware](./firmware/index.md)

QMK / Vial keyboard firmware on RP2350B tri-mode hardware:

- [RP2350B Hardware Baseline](./firmware/rp2350b-hardware-baseline.md)
- [Wireless Coprocessor Protocol](./firmware/wireless-coprocessor-protocol.md)
